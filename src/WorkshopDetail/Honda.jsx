    ...
    services: [
      {
        ...
        description:
          "Immediate help when your vehicle breaks down. Our team reaches you quickly with necessary tools and expertise to get you back on the road.",
      ...
      },
      {
        ...
        description:
          "Professional mechanics arrive at your doorstep to diagnose and repair vehicle issues, saving you time and hassle.",
      ...
      },
      {
        ...
        description:
          "Comprehensive vehicle check-up and maintenance to ensure optimal performance and prevent potential issues.",
      ...
      },
      {
        ...
        title: "Oil Change",
        description:
          "Expert oil change services and vehicle tuning to maintain engine health and improve overall vehicle performance.",
      ...
      },
      {
        ...
        title: "Tire Services",
        description:
          "Complete tire care including rotation, balancing, alignment, and replacement with high-quality tires.",
      ...
      },
      {
        ...
        description:
          "Keep your engine at the right temperature with our coolant replacement service, preventing overheating and corrosion.",
      ...
      },
      {
        ...
        title: "Brake Service",
        description:
          "Ensure safety with our expert brake inspection, repair, and replacement services for responsive and efficient braking.",
      ...
      },
      {
        ...
        description:
          "Improve ride comfort and stability with professional suspension repair and replacement using high-quality components.",
      ...
      },
      {
        ...
        description:
          "Expert battery testing, replacement, and maintenance to ensure reliable starts and long-lasting performance.",
      ...
      },
      {
        ...
        title: "Tuning",
        description:
          "Enhance your vehicle’s performance with professional tuning for improved efficiency, power, and fuel economy.",
    ...
    <div className="bg-gray-200 text-gray-900 min-h-screen">
            ...
            <div className="flex items-center space-x-2 mb-2">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className={`w-6 h-6 ${
                    i < Math.floor(workshopData.rating)
                      ? "text-yellow-400"
                      : "text-gray-300"
                  }`}
                />
      ...
      <div className="container mx-auto py-8">
        <div className="bg-gradient-to-r from-black to-blue-600 text-white rounded-lg p-12 text-center">
          ...
          <p className="mb-8">
            Book our services or get instant roadside assistance
          </p>
          <div className="flex justify-center space-x-4">
            <Link
              to="/bookings"
              className=" bg-yellow-500 text-black px-8 py-3 rounded-full hover:bg-yellow-600 hover:text-black transition-colors"
            >
              Book Service
            </Link>
            <Link
