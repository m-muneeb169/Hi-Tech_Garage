          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-gray-300 text-base leading-relaxed">
                Your trusted partner for professional automotive care and maintenance services in Faisalabad.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center space-y-2 p-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <span className="text-xs text-gray-300 font-medium">Expert Repair</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2 p-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <span className="text-xs text-gray-300 font-medium">5-Star Service</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-6 rounded-3xl shadow-2xl border border-gray-700/50">
                ...
                <div className="text-center">
                  ...
                  <div className="text-cyan-300 text-sm">Professional Auto Care</div>
                </div>
              </div>
...
//               <div className="flex flex-col items-center space-y-2 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
...
//               <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-gray-700/50">
...
//             {/* Location */}
//             <div className="group">
//               <div className="flex items-center space-x-4 p-4 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 hover:border-white/30 transform hover:-translate-y-1 transition-all duration-300">
//                 <div className="p-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl shadow-lg">
