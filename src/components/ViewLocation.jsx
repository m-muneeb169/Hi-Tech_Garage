...
//                         if (confirmedEmergency?.location && confirmedEmergency?.address) {
//                             setLocation(confirmedEmergency.location);
//                             setAddress(confirmedEmergency.address);
//                             found = true;
//                             break;
//                         }
//                     }
...
//                         <h3 className="font-semibold text-red-700 mb-1">User ID: {userId}</h3>
