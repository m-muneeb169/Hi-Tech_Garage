...
// //       await fetchAcceptedWorkshops(); // This will now respect the updated state
...
// // //   useEffect(() => {
// // //   if (user && bookedWorkshops.length === 0) {
// // //     fetchAcceptedWorkshops();
// // //   }
// // // }, [user, bookedWorkshops.length]);

// // // ✅ Replace your useEffect (that calls fetchAcceptedWorkshops) with this block
// // useEffect(() => {
// //   const initializeEmergencyState = async () => {
// //     await fetchUserEmergencies(); // 1. Check if already booked

// //     if (!hasBookedWorkshop) {
// //       await fetchAcceptedWorkshops(); // 2. Only fetch accepted if not booked
// //     } else {
// //       setAcceptedWorkshops([]); // 3. Clear accepted workshops if already booked
// //     }
// //   };
