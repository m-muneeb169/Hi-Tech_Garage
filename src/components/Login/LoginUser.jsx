...
//     if (!userDoc.exists()) {
//       // User exists in auth but not in users collection => could be workshop
...
//     // Check if this Google user exists in "users" collection
//     const userDoc = await getDoc(doc(db, "users", user.uid));
//     if (!userDoc.exists()) {
//       await auth.signOut();
//       localStorage.removeItem("loggedInUserId");
//       localStorage.removeItem("isLoggedIn");
//       showMessage("No user account found for Google Sign-in", "error");
//       return;
//     }
