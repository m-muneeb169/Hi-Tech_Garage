...
<section className="relative h-[70vh] overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        ...
        >
          ...
          >
            "Because your time matters—we service at your home."
          </motion.p>
...
<section className="py-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
  ...
  <div className="absolute inset-0 opacity-5">
    ...
    <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-500 rounded-full filter blur-3xl transform translate-x-1/2 translate-y-1/2"></div>
  </div>
  ...
  <div className="container mx-auto px-8 lg:px-16 relative z-10">
    ...
    >
      ...
      <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-cyan-500 mt-4 mx-auto rounded-full"></div>
    </motion.div>
    ...
    <motion.div
      ...
      className="grid md:grid-cols-3 gap-12 lg:gap-16 max-w-7xl mx-auto"
    >
      {[
        { icon: <Home size={28} />, title: 'COMFORT & CONVENIENCE', description: 'We bring the garage to your home — zero hassle.', gradient: 'from-blue-500 to-blue-600' },
        { icon: <Clock size={28} />, title: 'TIME-SAVING', description: 'Book in minutes, get service without leaving home.', gradient: 'from-cyan-500 to-blue-500' },
        { icon: <Shield size={28} />, title: 'QUALITY GUARANTEED', description: 'Skilled mechanics and genuine parts, always.', gradient: 'from-blue-600 to-indigo-600' }
      ].map((benefit, i) => (
        <motion.div
          key={i}
          variants={fadeUp}
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-cyan-500/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          
          <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/50 group-hover:border-blue-200/50">
            ...
            <div className="relative z-10 mb-6">
              <div className={`w-16 h-16 bg-gradient-to-r ${benefit.gradient} text-white rounded-2xl flex items-center justify-center mb-4 mx-auto transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                {benefit.icon}
              </div>
              
              {/* Floating Elements */}
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-blue-200 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-pulse"></div>
              <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-cyan-200 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse"></div>
            </div>

            {/* Content */}
            <div className="relative z-10 text-center">
              <h3 className="text-xl font-semibold mb-2 text-blue-900 font-['Barlow'] tracking-wide group-hover:text-blue-700 transition-colors duration-300">
                {benefit.title}
              </h3>
              <p className="text-gray-600 font-['Open_Sans'] leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                {benefit.description}
              </p>
            </div>

            {/* Bottom Accent Line */}
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full group-hover:w-16 transition-all duration-500"></div>
          </div>
        </motion.div>
      ))}
    </motion.div>
...
<section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50/30 relative overflow-hidden">
  ...
  <div className="absolute inset-0 opacity-10">
    <div className="absolute top-10 left-10 w-32 h-32 bg-blue-600 transform rotate-45"></div>
    <div className="absolute bottom-10 right-10 w-24 h-24 bg-cyan-500 transform rotate-12"></div>
    <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-blue-400 transform rotate-45"></div>
  </div>
  ...
  <div className="container mx-auto px-8 lg:px-16 relative z-10">
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      variants={staggerContainer}
      className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 max-w-7xl mx-auto"
    >
      {[
        { icon: <Settings size={24} />, title: 'ENGINE DIAGNOSTICS', description: 'Computer-based issue detection & solutions.', accent: 'blue' },
        { icon: <Wrench size={24} />, title: 'MAINTENANCE', description: 'Oil change, filters, and full servicing.', accent: 'cyan' },
        { icon: <Shield size={24} />, title: 'BRAKE SERVICE', description: 'Brake pad change & repairs with warranty.', accent: 'indigo' },
        { icon: <Settings size={24} />, title: 'BATTERY', description: 'Battery checks, jumpstarts, and replacement.', accent: 'blue' },
        { icon: <Wrench size={24} />, title: 'AC REPAIR', description: 'Cooling system cleaning and gas recharge.', accent: 'cyan' },
        { icon: <Shield size={24} />, title: 'ELECTRICAL FIXES', description: 'All wiring & system error corrections.', accent: 'indigo' }
      ].map((service, i) => (
        <motion.div
          key={i}
          variants={fadeUp}
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-200/50 to-cyan-200/50 rounded-2xl blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <div className="relative bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200/50 group-hover:border-blue-200/80 h-full flex flex-col">
            ...
            <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${
              service.accent === 'blue' ? 'from-blue-500 to-blue-600' :
              service.accent === 'cyan' ? 'from-cyan-500 to-blue-500' :
              'from-indigo-500 to-blue-600'
            } rounded-t-2xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}></div>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className={`w-14 h-14 bg-gradient-to-r ${
                ...
                service.accent === 'cyan' ? 'from-cyan-500 to-blue-500' :
                'from-indigo-500 to-blue-600'
              } text-white rounded-xl flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
                {service.icon}
              </div>
              <h3 className="text-xl font-semibold text-blue-900 font-['Barlow'] tracking-wide group-hover:text-blue-700 transition-colors duration-300">
                {service.title}
              </h3>
            </div>
            ...
            {/* Side accent */}
            <div className={`absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-0 bg-gradient-to-b ${
              service.accent === 'blue' ? 'from-blue-500 to-blue-600' :
              service.accent === 'cyan' ? 'from-cyan-500 to-blue-500' :
              'from-indigo-500 to-blue-600'
            } rounded-r-full group-hover:h-12 transition-all duration-500`}></div>
          </div>
        </motion.div>
      ))}
    </motion.div>
