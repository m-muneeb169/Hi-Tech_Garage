...
Periodic Car Servicing
            ...
            <p className="text-xl text-white mb-8">
              Keep your vehicle in peak condition with our comprehensive
            ...
            {[
              {
                ...
                description:
                  "Catch potential issues before they become major problems with regular inspections",
              },
              {
                icon: <Settings className="w-12 h-12 text-blue-600" />,
                title: "Peak Performance",
                description:
                  "Maintain optimal vehicle performance with scheduled maintenance and tune-ups",
              },
              {
                icon: <Star className="w-12 h-12 text-blue-600" />,
                title: "Preserve Value",
                description:
                  "Maintain your vehicle's resale value with documented service history",
              },
            ].map((benefit, index) => (
              <div
                key={index}
            ...
            {[
              {
                ...
                description:
                  "Multi-point inspection covering all crucial vehicle systems",
              },
              {
                icon: <Settings className="w-8 h-8 text-blue-600" />,
                title: "Fluid Services",
                description: "Check and top-up all essential fluids",
              },
              {
                icon: <Wrench className="w-8 h-8 text-blue-600" />,
                title: "Filter Replacement",
                description: "Replace air, oil, and fuel filters as needed",
              },
              {
                icon: <Shield className="w-8 h-8 text-blue-600" />,
                title: "Component Check",
                description: "Inspect belts, hoses, and critical components",
              },
              {
                icon: <Wrench className="w-8 h-8 text-blue-600" />,
                title: "AC Service",
